...
# Dynamic version with delta + mood + guided attention support
SRCS_DYN = $(SRC_DIR)/model.c $(SRC_DIR)/delta.c $(SRC_DIR)/mood.c $(SRC_DIR)/guided.c $(SRC_DIR)/arianna_dynamic.c
...
$(TARGET_DYN): $(SRCS_DYN) $(SRC_DIR)/arianna.h $(SRC_DIR)/delta.h $(SRC_DIR)/mood.h $(SRC_DIR)/guided.h
	@mkdir -p $(BIN_DIR)
