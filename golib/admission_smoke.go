...
func runAdmissionLiveRouteTurnCandidateNanoDirectChatShadowSmoke() error {
	...
	boundaryReportInputs := []admissionLiveRouteBoundaryReportInput{
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionRollbackImplementationDryRun(),
			Name:                    "rollback_implementation",
			BodyInventoryStatus:     rollbackImpl.BodyInventoryStatus,
			RouteAvailabilityStatus: rollbackImpl.RouteAvailabilityStatus,
			RouteAvailabilityReason: rollbackImpl.RouteAvailabilityReason,
			RouteMissingOrgans:      rollbackImpl.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionLedgerImplementationDryRun(),
			Name:                    "ledger_implementation",
			BodyInventoryStatus:     ledgerImpl.BodyInventoryStatus,
			RouteAvailabilityStatus: ledgerImpl.RouteAvailabilityStatus,
			RouteAvailabilityReason: ledgerImpl.RouteAvailabilityReason,
			RouteMissingOrgans:      ledgerImpl.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionLedgerPersistenceDryRun(),
			Name:                    "ledger_persistence",
			BodyInventoryStatus:     ledgerPersistence.BodyInventoryStatus,
			RouteAvailabilityStatus: ledgerPersistence.RouteAvailabilityStatus,
			RouteAvailabilityReason: ledgerPersistence.RouteAvailabilityReason,
			RouteMissingOrgans:      ledgerPersistence.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionLedgerVerificationDryRun(),
			Name:                    "ledger_verification",
			BodyInventoryStatus:     ledgerVerification.BodyInventoryStatus,
			RouteAvailabilityStatus: ledgerVerification.RouteAvailabilityStatus,
			RouteAvailabilityReason: ledgerVerification.RouteAvailabilityReason,
			RouteMissingOrgans:      ledgerVerification.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionReadinessDryRun(),
			Name:                    "admission_readiness",
			BodyInventoryStatus:     readiness.BodyInventoryStatus,
			RouteAvailabilityStatus: readiness.RouteAvailabilityStatus,
			RouteAvailabilityReason: readiness.RouteAvailabilityReason,
			RouteMissingOrgans:      readiness.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionPermitDryRun(),
			Name:                    "admission_permit",
			BodyInventoryStatus:     permit.BodyInventoryStatus,
			RouteAvailabilityStatus: permit.RouteAvailabilityStatus,
			RouteAvailabilityReason: permit.RouteAvailabilityReason,
			RouteMissingOrgans:      permit.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionSealDryRun(),
			Name:                    "admission_seal",
			BodyInventoryStatus:     seal.BodyInventoryStatus,
			RouteAvailabilityStatus: seal.RouteAvailabilityStatus,
			RouteAvailabilityReason: seal.RouteAvailabilityReason,
			RouteMissingOrgans:      seal.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionFinalGateDryRun(),
			Name:                    "final_gate",
			BodyInventoryStatus:     finalGate.BodyInventoryStatus,
			RouteAvailabilityStatus: finalGate.RouteAvailabilityStatus,
			RouteAvailabilityReason: finalGate.RouteAvailabilityReason,
			RouteMissingOrgans:      finalGate.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceIntentDryRun(),
			Name:                    "resonance_intent",
			BodyInventoryStatus:     resonanceIntent.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceIntent.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceIntent.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceIntent.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceReceiverDryRun(),
			Name:                    "resonance_receiver",
			BodyInventoryStatus:     resonanceReceiver.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceReceiver.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceReceiver.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceReceiver.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceObservationDryRun(),
			Name:                    "resonance_observation",
			BodyInventoryStatus:     resonanceObservation.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceObservation.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceObservation.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceObservation.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftBoundaryDryRun(),
			Name:                    "resonance_graft_boundary",
			BodyInventoryStatus:     resonanceGraftBoundary.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftBoundary.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftBoundary.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftBoundary.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftPreflightDryRun(),
			Name:                    "resonance_graft_preflight",
			BodyInventoryStatus:     resonanceGraftPreflight.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftPreflight.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftPreflight.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftPreflight.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftGateDryRun(),
			Name:                    "resonance_graft_gate",
			BodyInventoryStatus:     resonanceGraftGate.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftGate.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftGate.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftGate.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftCandidateDryRun(),
			Name:                    "resonance_graft_candidate",
			BodyInventoryStatus:     resonanceGraftCandidate.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftCandidate.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftCandidate.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftCandidate.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftCandidateStoreDryRun(),
			Name:                    "resonance_graft_candidate_store",
			BodyInventoryStatus:     resonanceGraftCandidateStore.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftCandidateStore.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftCandidateStore.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftCandidateStore.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftCandidateStoreReaderDryRun(),
			Name:                    "resonance_graft_candidate_store_reader",
			BodyInventoryStatus:     resonanceGraftCandidateStoreReader.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftCandidateStoreReader.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftCandidateStoreReader.RouteAvailabilityReason,
			RouteMissingOrgans:      resonanceGraftCandidateStoreReader.RouteMissingOrgans,
		},
		{
			Enabled:                 admissionLiveRouteTurnCandidateAdmissionResonanceGraftAdmissionProofDryRun(),
			Name:                    "resonance_graft_admission_proof",
			BodyInventoryStatus:     resonanceGraftAdmissionProof.BodyInventoryStatus,
			RouteAvailabilityStatus: resonanceGraftAdmissionProof.RouteAvailabilityStatus,
			RouteAvailabilityReason: resonanceGraftAdmissionProof.RouteAvailabilityReason,
