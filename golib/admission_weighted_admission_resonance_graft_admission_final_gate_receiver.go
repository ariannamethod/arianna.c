...
const admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverSchema = "arianna.live_route_weighted_admission_resonance_graft_admission_final_gate_receiver.v1"

type admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport struct {
	admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentReport
	...
	WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReady      bool    `json:"weighted_admission_resonance_graft_admission_final_gate_receiver_ready"`
	WeightedAdmissionResonanceGraftAdmissionFinalGateIntentConsumed     bool    `json:"weighted_admission_resonance_graft_admission_final_gate_intent_consumed"`
	WeightedAdmissionResonanceGraftAdmissionFinalGateIntentRequired     bool    `json:"weighted_admission_resonance_graft_admission_final_gate_intent_required"`
	NextStepBlockedWithoutResonanceGraftAdmissionFinalGateReceiver      bool    `json:"next_step_blocked_without_resonance_graft_admission_final_gate_receiver"`
	WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID         string  `json:"weighted_admission_resonance_graft_admission_final_gate_receiver_id"`
	...
	SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentID     string  `json:"source_weighted_admission_resonance_graft_admission_final_gate_intent_id"`
	...
	SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentCausal string  `json:"source_weighted_admission_resonance_graft_admission_final_gate_intent_causal_id"`
...
func runAdmissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiver(args []string) error {
	if len(args) != 2 {
		return fmt.Errorf("usage: --admission-live-route-weighted-admission-resonance-graft-admission-final-gate-receiver RESONANCE_GRAFT_ADMISSION_FINAL_GATE_INTENT_REPORT RESONANCE_GRAFT_ADMISSION_FINAL_GATE_RECEIVER_REPORT")
	}
	intentPath := args[0]
	outputPath := args[1]
	if strings.TrimSpace(outputPath) == "" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver output path missing")
	}
	sourceIntent, root, err := readAdmissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentReportForAssert(intentPath)
	if err != nil {
		return err
	}
	if err := admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentReportError(sourceIntent, root); err != nil {
		return err
	}
	receiver := admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport{
		admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentReport: sourceIntent,
		...
		AdmissionFinalGateReceiverTargetKind:                                "weighted_internal_world_shadow_graft_admission_final_gate_intent",
		...
		WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReady:      true,
		WeightedAdmissionResonanceGraftAdmissionFinalGateIntentConsumed:     true,
		WeightedAdmissionResonanceGraftAdmissionFinalGateIntentRequired:     true,
		NextStepBlockedWithoutResonanceGraftAdmissionFinalGateReceiver:      true,
		SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentID:     sourceIntent.WeightedAdmissionResonanceGraftAdmissionFinalGateIntentID,
		SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentReady:  sourceIntent.WeightedAdmissionResonanceGraftAdmissionFinalGateIntentReady,
		SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentCausal: sourceIntent.CausalID,
	...
	receiver.Schema = admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverSchema
	...
	if receiver.CausalID == "" ||
		...
		receiver.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID == "" ||
		receiver.AdmissionFinalGateReceiverPreStateHash == receiver.AdmissionFinalGateReceiverPostStateHash {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver state proof failed")
	}
	raw, err := json.MarshalIndent(receiver, "", "  ")
	if err != nil {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver marshal failed: %w", err)
	}
	raw = append(raw, '\n')
	if err := os.WriteFile(outputPath, raw, 0600); err != nil {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver write failed: %w", err)
	}
	fmt.Printf("[admission-live-route-weighted-admission-resonance-graft-admission-final-gate-receiver] pass: resonance_graft_admission_final_gate_receiver_report=%s resonance_graft_admission_final_gate_intent_report=%s\n", outputPath, intentPath)
	return nil
}

func runAdmissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverAssert(args []string) error {
	if len(args) != 1 {
		return fmt.Errorf("usage: --admission-live-route-weighted-admission-resonance-graft-admission-final-gate-receiver-assert REPORT")
	}
	report, root, err := readAdmissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReportForAssert(args[0])
	if err != nil {
		return err
	}
	return admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReportError(report, root)
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReportError(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport, root map[string]json.RawMessage) error {
	if _, ok := root["schema"]; !ok {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver schema missing")
	}
	if report.Schema != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverSchema {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver schema mismatch: got %q want %q", report.Schema, admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverSchema)
	}
	if report.Status != "shadow_graft_admission_final_gate_receiver_previewed_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver status mismatch: got %q want %q", report.Status, "shadow_graft_admission_final_gate_receiver_previewed_dry_run")
	}
	if report.Target != "live_route_admission_next_step" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver target mismatch: got %q want %q", report.Target, "live_route_admission_next_step")
	}
	if report.TargetKind != "weighted_internal_world_shadow_graft_admission_final_gate_receiver" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver target_kind mismatch: got %q want %q", report.TargetKind, "weighted_internal_world_shadow_graft_admission_final_gate_receiver")
	}
	if report.TargetMode != "bounded_receiver_preview_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver target_mode mismatch: got %q want %q", report.TargetMode, "bounded_receiver_preview_dry_run")
	}
	if report.Action != "preview_weighted_resonance_shadow_graft_admission_final_gate_receiver_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver action mismatch: got %q want %q", report.Action, "preview_weighted_resonance_shadow_graft_admission_final_gate_receiver_dry_run")
	}
	if report.WriterAction != "reject_blocked_admission_final_gate_receiver" || report.RollbackAction != "reject_blocked_admission_final_gate_receiver" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver writer/rollback action mismatch")
	}
	if report.LedgerState != "blocked" ||
		...
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver ledger guard mismatch")
	}
	if report.AdmissionFinalGateReceiverState != "previewed" ||
		...
		report.AdmissionFinalGateReceiverTargetKind != "weighted_internal_world_shadow_graft_admission_final_gate_intent" ||
		report.AdmissionFinalGateReceiverTargetMode != "bounded_receiver_preview_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver shape mismatch")
	}
	if report.ReceiptShape != "weighted_resonance_shadow_graft_admission_final_gate_receiver_receipt" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver receipt_shape mismatch: got %q want %q", report.ReceiptShape, "weighted_resonance_shadow_graft_admission_final_gate_receiver_receipt")
	}
	for _, required := range []struct {
		...
		{"next_step_blocked_without_resonance_graft_admission_final_gate_receiver", report.NextStepBlockedWithoutResonanceGraftAdmissionFinalGateReceiver},
		...
		if !required.value {
			return fmt.Errorf("weighted admission resonance graft admission final gate receiver %s not ready", required.name)
		}
	}
	for _, closed := range []struct {
		...
		if closed.value {
			return fmt.Errorf("weighted admission resonance graft admission final gate receiver opened %s", closed.name)
		}
	}
	if report.FinalGateReceiver != "resonance" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver receiver mismatch: got %q want %q", report.FinalGateReceiver, "resonance")
	}
	if report.FinalGateReceiverKind != "internal_world" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver receiver_kind mismatch: got %q want %q", report.FinalGateReceiverKind, "internal_world")
	}
	if report.FinalGateReceiverInfluenceKind != "bounded_direction" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver influence_kind mismatch: got %q want %q", report.FinalGateReceiverInfluenceKind, "bounded_direction")
	}
	if report.FinalGateReceiverMaxInfluence != admissionLiveRouteTurnCandidateAdmissionResonanceIntentMaxGain {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver max_influence mismatch: got %.6f want %.6f", report.FinalGateReceiverMaxInfluence, admissionLiveRouteTurnCandidateAdmissionResonanceIntentMaxGain)
	}
	if report.FinalGateReceiverTTLTurns != admissionLiveRouteTurnCandidateAdmissionResonanceIntentTTL {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver ttl_turns mismatch: got %d want %d", report.FinalGateReceiverTTLTurns, admissionLiveRouteTurnCandidateAdmissionResonanceIntentTTL)
	}
	if report.FinalGateReceiverStateHashMode != "blocked_intent_receiver_preview" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver state_hash_mode mismatch: got %q want %q", report.FinalGateReceiverStateHashMode, "blocked_intent_receiver_preview")
	}
	for _, requiredString := range []struct {
		name  string
		value string
	}{
		{"weighted_admission_resonance_graft_admission_final_gate_receiver_id", report.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID},
		...
		{"source_weighted_admission_resonance_graft_admission_final_gate_intent_causal_id", report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentCausal},
		...
		if strings.TrimSpace(requiredString.value) == "" {
			return fmt.Errorf("weighted admission resonance graft admission final gate receiver %s missing", requiredString.name)
		}
	}
	if report.SourceSchema != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentSchema {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source_schema mismatch: got %q want %q", report.SourceSchema, admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateIntentSchema)
	}
	if report.SourceStatus != "shadow_graft_admission_final_gate_intent_blocked_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source_status mismatch: got %q want %q", report.SourceStatus, "shadow_graft_admission_final_gate_intent_blocked_dry_run")
	}
	if report.SourceTarget != "live_route_admission_next_step" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source_target mismatch: got %q want %q", report.SourceTarget, "live_route_admission_next_step")
	}
	if report.SourceAdmissionFinalGateIntentReceiptShape != "weighted_resonance_shadow_graft_admission_final_gate_intent_receipt" ||
		...
		report.SourceAdmissionFinalGateIntentTargetKind != "weighted_internal_world_shadow_graft_admission_final_gate" ||
		report.SourceAdmissionFinalGateIntentTargetMode != "bounded_intent_guard_dry_run" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source admission final gate intent shape mismatch")
	}
	if report.SourceFinalGateIntentReceiver != "resonance" ||
		...
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source final gate intent receiver mismatch")
	}
	if report.SourceAdmissionFinalGateIntentReason != "weighted resonance shadow graft admission final gate intent drafted from blocked final gate; live admission remains closed" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source_admission_final_gate_intent_reason mismatch: got %q", report.SourceAdmissionFinalGateIntentReason)
	}
	if !strings.HasPrefix(report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentID, "weighted-resonance-graft-admission-final-gate-intent-id-") ||
		!strings.HasPrefix(report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentCausal, "weighted-resonance-graft-admission-final-gate-intent-causal-") ||
		!strings.HasPrefix(report.SourceAdmissionFinalGateIntentHash, "weighted-resonance-graft-admission-final-gate-intent-") ||
		!strings.HasPrefix(report.SourceAdmissionFinalGateIntentReadBack, "weighted-resonance-graft-admission-final-gate-intent-read-") {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver source final gate intent mismatch")
	}
	if report.BodyTarget != "none" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver body_target mismatch: got %q want %q", report.BodyTarget, "none")
	}
	if report.CausalID == "" || report.CausalID != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverCausalID(report) {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver causal_id mismatch")
	}
	if report.AdmissionFinalGateReceiverPreStateHash == "" || report.AdmissionFinalGateReceiverPreStateHash != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverPreStateHash(report) {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver pre_state_hash mismatch")
	}
	if report.AdmissionFinalGateReceiverPostStateHash == "" || report.AdmissionFinalGateReceiverPostStateHash != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverPostStateHash(report) {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver post_state_hash mismatch")
	}
	if report.AdmissionFinalGateReceiverStateDeltaHash == "" || report.AdmissionFinalGateReceiverStateDeltaHash != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverStateDeltaHash(report) {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver state_delta_hash mismatch")
	}
	if report.AdmissionFinalGateReceiverPreStateHash == report.AdmissionFinalGateReceiverPostStateHash {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver state proof collapsed")
	}
	if report.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID == "" || report.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID != admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID(report) {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver id mismatch")
	}
	if report.Reason != "weighted resonance shadow graft admission final gate receiver previewed from blocked final gate intent; live admission remains closed" {
		return fmt.Errorf("weighted admission resonance graft admission final gate receiver reason mismatch: got %q", report.Reason)
	}
	return nil
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverCausalID(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport) string {
	h := hashJSON(struct {
		...
		SourceIntentID:   report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateIntentID,
	...
	return "weighted-resonance-graft-admission-final-gate-receiver-causal-" + h
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverPreStateHash(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport) string {
	h := hashJSON(struct {
		SourceIntentID   string `json:"source_admission_final_gate_intent_id"`
		...
		SourceIntentRead: report.SourceAdmissionFinalGateIntentReadBack,
		SourceFinalGate:  report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateID,
		SourceFinalRead:  report.SourceWeightedAdmissionResonanceGraftAdmissionFinalGateReadBack,
		StateHashMode:    report.FinalGateReceiverStateHashMode,
		Receiver:         report.FinalGateReceiver,
		ReceiverKind:     report.FinalGateReceiverKind,
		IntentConsumed:   report.WeightedAdmissionResonanceGraftAdmissionFinalGateIntentConsumed,
		IntentRequired:   report.WeightedAdmissionResonanceGraftAdmissionFinalGateIntentRequired,
		ReceiverReady:    report.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReady,
	})
	if h == "" {
		return ""
	}
	return "weighted-resonance-graft-admission-final-gate-receiver-pre-" + h
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverPostStateHash(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport) string {
	h := hashJSON(struct {
	...
	return "weighted-resonance-graft-admission-final-gate-receiver-post-" + h
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverStateDeltaHash(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport) string {
	h := hashJSON(struct {
		PreStateHash        string `json:"pre_state_hash"`
	...
	return "weighted-resonance-graft-admission-final-gate-receiver-delta-" + h
}

func admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverID(report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport) string {
	h := hashJSON(struct {
		...
		NextStepBlockedWithout bool   `json:"next_step_blocked_without_resonance_graft_admission_final_gate_receiver"`
	}{
		...
		Ready:                  report.WeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReady,
		ReceiverReady:          report.AdmissionFinalGateReceiverReady,
	...
	return "weighted-resonance-graft-admission-final-gate-receiver-id-" + h
}

func readAdmissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReportForAssert(path string) (admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport, map[string]json.RawMessage, error) {
	var report admissionLiveRouteWeightedAdmissionResonanceGraftAdmissionFinalGateReceiverReport
	if strings.TrimSpace(path) == "" {
		return report, nil, fmt.Errorf("weighted admission resonance graft admission final gate receiver path missing")
	}
	raw, err := os.ReadFile(path)
	if err != nil {
		if os.IsNotExist(err) {
			return report, nil, fmt.Errorf("weighted admission resonance graft admission final gate receiver not written")
		}
	...
	if err := json.Unmarshal(raw, &root); err != nil {
		return report, nil, fmt.Errorf("weighted admission resonance graft admission final gate receiver JSON invalid: %w", err)
	}
	if err := json.Unmarshal(raw, &report); err != nil {
		return report, nil, fmt.Errorf("weighted admission resonance graft admission final gate receiver decode failed: %w", err)
	}
