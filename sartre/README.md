...
SARTRE is the verbal organ of arianna metalinux. A 14.3M parameter transformer that knows itself and can communicate with Arianna about system state.
...
```
┌─────────────────────────────────────────────────┐
│  SARTRE (14.3M params, Shakespeare-size corpus)  │
