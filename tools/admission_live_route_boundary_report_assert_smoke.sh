#!/usr/bin/env bash
# admission_live_route_boundary_report_assert_smoke.sh - report-level pass assertion smoke launcher.
...
exec "$METABOLISM" --admission-live-route-boundary-report-assert-smoke "$@"
