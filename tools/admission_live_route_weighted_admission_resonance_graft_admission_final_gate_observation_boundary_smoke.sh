#!/usr/bin/env bash
# admission_live_route_weighted_admission_resonance_graft_admission_final_gate_observation_boundary_smoke.sh - declare final-gate observation boundary from compact weighted graft admission final-gate observation.
...
WORKDIR="${A2A_ADMISSION_LIVE_ROUTE_WEIGHTED_ADMISSION_RESONANCE_GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_WORKDIR:-$(mktemp -d "${tmp_root%/}/arianna-live-route-weighted-admission-resonance-graft-admission-final-gate-observation-boundary.XXXXXX")}"
OBSERVATION_WORKDIR="$WORKDIR/final_gate_observation"
...
GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT="${A2A_ADMISSION_LIVE_ROUTE_WEIGHTED_ADMISSION_RESONANCE_GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT:-$WORKDIR/live_route_weighted_admission_resonance_graft_admission_final_gate_observation_boundary.json}"
...
die() {
    echo "[admission-live-route-weighted-admission-resonance-graft-admission-final-gate-observation-boundary-smoke] FAIL: $*" >&2
...
if ! A2A_ADMISSION_LIVE_ROUTE_WEIGHTED_ADMISSION_RESONANCE_GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_WORKDIR="$OBSERVATION_WORKDIR" \
    ...
    bash "$ROOT/tools/admission_live_route_weighted_admission_resonance_graft_admission_final_gate_observation_smoke.sh" >"$OBSERVATION_LOG" 2>&1; then
...
if ! bash "$ROOT/tools/admission_live_route_weighted_admission_resonance_graft_admission_final_gate_observation_boundary.sh" "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_REPORT" "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" >"$BOUNDARY_LOG" 2>&1; then
    die "weighted admission resonance graft admission final gate observation boundary rejected observation report"
fi
...
require_grep '"schema": "arianna.live_route_weighted_admission_resonance_graft_admission_final_gate_observation_boundary.v1"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary schema"
require_grep '"status": "shadow_graft_admission_final_gate_observation_boundary_declared_dry_run"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary status"
...
require_grep '"target_kind": "weighted_internal_world_shadow_graft_admission_final_gate_observation_boundary"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary target kind"
...
require_grep '"action": "declare_weighted_resonance_shadow_graft_admission_final_gate_observation_boundary_dry_run"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary action"
...
require_grep '"receipt_shape": "weighted_resonance_shadow_graft_admission_final_gate_observation_boundary_receipt"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "receipt shape"
...
require_grep '"weighted_admission_resonance_graft_admission_final_gate_observation_boundary_ready": true' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "weighted boundary ready"
require_grep '"weighted_admission_resonance_graft_admission_final_gate_observation_consumed": true' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "observation consumed"
require_grep '"weighted_admission_resonance_graft_admission_final_gate_observation_required": true' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "observation required"
require_grep '"next_step_blocked_without_resonance_graft_admission_final_gate_observation_boundary": true' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "next-step block"
require_grep '"weighted_admission_resonance_graft_admission_final_gate_observation_boundary_id": "weighted-resonance-graft-admission-final-gate-observation-boundary-id-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary id"
require_grep '"causal_id": "weighted-resonance-graft-admission-final-gate-observation-boundary-causal-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary causal"
require_grep '"admission_final_gate_observation_boundary_hash": "weighted-resonance-graft-admission-final-gate-observation-boundary-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary hash"
require_grep '"admission_final_gate_observation_boundary_read_back_hash": "weighted-resonance-graft-admission-final-gate-observation-boundary-read-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary read-back hash"
require_grep '"source_schema": "arianna.live_route_weighted_admission_resonance_graft_admission_final_gate_observation.v1"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source observation schema"
require_grep '"source_status": "shadow_graft_admission_final_gate_observation_recorded_dry_run"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source observation status"
require_grep '"source_weighted_admission_resonance_graft_admission_final_gate_observation_id": "weighted-resonance-graft-admission-final-gate-observation-id-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source observation id"
require_grep '"source_weighted_admission_resonance_graft_admission_final_gate_observation_ready": true' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source observation ready"
require_grep '"source_admission_final_gate_observation_append_hash": "weighted-resonance-graft-admission-final-gate-observation-append-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source append hash"
require_grep '"source_admission_final_gate_observation_read_back_hash": "weighted-resonance-graft-admission-final-gate-observation-read-' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "source read-back hash"
...
require_grep '"reason": "weighted resonance shadow graft admission final gate observation boundary declared from recorded observation; live admission remains closed"' "$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT" "boundary reason"
require_grep '\[admission-live-route-weighted-admission-resonance-graft-admission-final-gate-observation-boundary\] pass:' "$BOUNDARY_LOG" "boundary pass line"

echo "[admission-live-route-weighted-admission-resonance-graft-admission-final-gate-observation-boundary-smoke] pass: resonance_graft_admission_final_gate_observation_report=$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_REPORT resonance_graft_admission_final_gate_observation_boundary_report=$GRAFT_ADMISSION_FINAL_GATE_OBSERVATION_BOUNDARY_REPORT"
